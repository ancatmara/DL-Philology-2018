...
**Граф, или сеть**– это модель, состоящая из**узлов**и связей между ними, или**ребер**. По-английски это называется_nodes \(vertices\)_и_edges_.
...
![](https://ancatmara.gitbooks.io/digital-literacy-for-culturologists/content/assets/fdsdzimport.png)
...
![](https://ancatmara.gitbooks.io/digital-literacy-for-culturologists/content/assets/tyijimport.png)
...
![](https://ancatmara.gitbooks.io/digital-literacy-for-culturologists/content/assets/ouilkimport.png)
...
![](https://ancatmara.gitbooks.io/digital-literacy-for-culturologists/content/assets/opouiyimport.png)
...
![](https://ancatmara.gitbooks.io/digital-literacy-for-culturologists/content/assets/pppimport.png)
...
![](https://ancatmara.gitbooks.io/digital-literacy-for-culturologists/content/assets/poiuiimport.png)
...
![](https://ancatmara.gitbooks.io/digital-literacy-for-culturologists/content/assets/%D0%A1%D0%BD%D0%B8%D0%BC%D0%BE%D0%BA%20%D1%8D%D0%BA%D1%80%D0%B0%D0%BD%D0%B0%202018-04-13%20%D0%B2%202.35.35.png)

Кстати, необязательно ждать, пока укладка закончится \(спойлер:[она может идти вечно](https://www.dropbox.com/s/ek84sjxsanm1rda/force_layout.mp4?dl=0)\) -- если результат вас устраивает, можно просто нажать_Стоп_. Если вам кажется, что узлы расположены слишком тесно, можно использовать «Расширение» \(Expand\). Если вам кажется, что граф вверх ногами, то можно использовать «Поворот» \(Rotate\)

Выберите самую репрезентативную, на ваш взгляд, укладку. Может получиться так:

![](https://ancatmara.gitbooks.io/digital-literacy-for-culturologists/content/assets/piuhjl;import.png)

Кроме того, вы можете захотеть добавить подписи узлов \(они называются**метками**, или_labels_\). Для работы с ними предусмотрена панель инструментов снизу от области с графом. Чтобы подписи появились, нужно нажать на черную букву Т; правее можно выбрать цвет, шрифт и кегль \(в этом датасете подписей нет, но вообще это может пригодиться\).
